...
export default function OurBenefits() {
  ...
  const newBannerList = [
    ...
    },
    {
      ...
      text: 'Make a swap on BitBank at no cost. Up to 50% of the trading fee returned in BT tokens.',
    },
    {
      image: '/images/bitbank/our_04.png',
      title: 'Multi-type Referral Program',
      text: 'Invite your friends & earn up to 20% commission reward every time they make a swap on BitBank and gain crypto in Farms, Launchpools, Lottery.',
    },
  ]
  const TotalList = [
    {
